...
public class ConsoleReportStyler {
    ...
    public static String styleOutcome(final String outcome, final Sentiment sentiment) {
    ...
    public static String styleOutcome(final String outcome, final boolean isPositive) {
        return styleOutcome(outcome, isPositive ? Sentiment.POSITIVE : Sentiment.NEGATIVE);
    }
