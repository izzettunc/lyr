...
class ScanLambdaFunctionWithUnboundedConcurrencyRuleConfigTest {
    ...
    void testThatScanLambdaFunctionWithUnboundedConcurrencyRuleConfigIsParsedToNull() {
        ...
        final ScanLambdaFunctionWithUnboundedConcurrencyRuleConfig expectedRuleConfig = ScanLambdaFunctionWithUnboundedConcurrencyRuleConfig.builder().build();
    ...
    void testThatScanLambdaFunctionWithUnboundedConcurrencyRuleConfigIsCopiedCorrectly() {
        // Given
        final var expectedConfig = ScanLambdaFunctionWithUnboundedConcurrencyRuleConfig.builder().build();
