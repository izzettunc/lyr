...
```bash
java -jar lyr-1.3.0.jar scan-env aws
```
...
```console
lyr@lyr:~$ java -jar lyr-1.3.0.jar scan-env aws --help
...
scan.lambda.function.withoutAnyActiveTrigger:
  triggerStatesConsideredAsActive: ["creating", "enabling", "enabled", "updating"]
