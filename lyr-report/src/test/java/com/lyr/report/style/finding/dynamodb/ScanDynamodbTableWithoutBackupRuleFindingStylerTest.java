...
class ScanDynamodbTableWithoutBackupRuleFindingStylerTest {
    ...
    ScanDynamodbTableWithoutBackupRuleFindingStyler testObject;

    @BeforeEach
    public void beforeEach() {
        testObject = new ScanDynamodbTableWithoutBackupRuleFindingStyler();
    ...
    void testThatReportReturnsAReportAsAStringWhenThereAreFindings() {
        ...
        final var expectedRawLines = List.of(
                "DynamoDB table 'dummy' has no backup configured for it.",
                "DynamoDB table 'dummy2' has no backup configured for it.");
    ...
    void testThatReportReturnsAReportAsAStringWhenThereAreNoFindings() {
        ...
        final var expectedRawLines = List.of("No DynamoDB tables found without a backup configuration.");
